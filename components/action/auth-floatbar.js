...
export function AuthFloatbar() {
  ...
  return (
    <>
      ...
      <div title="切换主题" className="hidden cursor-pointer absolute right-2 bottom-8 w-12 h-12 transition duration-700 rounded-full shadow-lg bg-white dark:bg-zinc-700"
        onClick={switchTheme}
      >
